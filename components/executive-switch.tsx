...
export function ExecutiveSwitch({
  ...
  return (
    <div className="relative h-full">
      <Button
        className={cn(
          "group relative flex h-full w-full items-center justify-between gap-1 sm:gap-2 lg:gap-3 rounded-lg sm:rounded-xl border border-white/20 bg-gradient-to-r from-white/90 to-white/80 px-1.5 sm:px-3 lg:px-4 py-1 sm:py-2 lg:py-2.5 text-left shadow-rose-200/20 shadow-xl backdrop-blur-md transition-all duration-300",
        ...
        <div className="relative flex w-full items-center gap-0.5 sm:gap-2 lg:gap-3">
          ...
          <div className="min-w-0 flex-1 overflow-hidden">
            <div className="flex items-center">
              <span className="truncate font-bold text-slate-800 text-[9px] sm:text-xs leading-tight">
                {selectedPersonality.name.split(' ')[0]}
              </span>
            </div>
            <span className="hidden sm:block truncate font-medium text-slate-500 text-[8px] sm:text-[10px] leading-tight">
          ...
          <div className="flex flex-shrink-0 items-center gap-0.5 sm:gap-1.5 lg:gap-2">
            <Badge
              className="hidden md:inline-flex border-0 bg-gradient-to-r from-rose-500 to-rose-600 px-1 md:px-2 py-0.5 font-semibold text-white text-[8px] md:text-[9px] shadow-lg"
              variant="secondary"
            >
              Active
            </Badge>
            ...
            <div className="absolute inset-0 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
              ...
              >
                ...
                <Card className="overflow-hidden border-0 bg-gradient-to-br from-white/98 via-white/95 to-white/98 shadow-2xl shadow-rose-300/50 backdrop-blur-xl">
                  {/* Modal Header */}
                  <div className="relative border-b border-white/20 bg-gradient-to-r from-rose-100/80 via-purple-100/80 to-indigo-100/80 px-8 py-8">
                    {/* Decorative Background */}
                    <div className="absolute inset-0 bg-gradient-to-r from-rose-400/10 via-purple-400/10 to-indigo-400/10"></div>
                    <div className="absolute top-0 left-0 h-full w-32 bg-gradient-to-r from-rose-200/30 to-transparent blur-3xl"></div>
                    <div className="absolute top-0 right-0 h-full w-32 bg-gradient-to-l from-indigo-200/30 to-transparent blur-3xl"></div>
                    ...
                    <div className="relative z-10">
                      <div className="flex items-center justify-between">
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              <div className="absolute inset-0 animate-pulse">
                                <div className="h-8 w-8 rounded-full bg-rose-400/30 blur-xl"></div>
                              </div>
                            </motion.div>
                          </div>
                          <div>
                            <h1 className="bg-gradient-to-r from-rose-700 via-purple-700 to-indigo-700 bg-clip-text text-3xl font-bold text-transparent">
                              Select Executive Advisor
                            </h1>
                            <p className="mt-2 text-slate-600 text-lg">
                              Choose your AI consultant to guide your conversation
                            </p>
                          </div>
                        </div>
                        ...
                        {/* Close Button */}
                        <Button
                          className="h-12 w-12 rounded-full border border-white/60 bg-white/80 text-slate-600 shadow-lg transition-all duration-200 hover:bg-white hover:shadow-xl hover:-translate-y-0.5"
                          onClick={() => setIsOpen(false)}
                          size="icon"
                          variant="outline"
                        >
                  ...
                  <div className="p-8">
                    <div className="grid gap-8 lg:grid-cols-2">
                      ...
                      <div className="space-y-6">
                        <div className="flex items-center gap-3">
                          <div className="h-px bg-gradient-to-r from-rose-200 to-transparent flex-1"></div>
                          <div className="flex items-center gap-2">
                            <Badge className="border-0 bg-emerald-100 font-semibold text-emerald-700 px-4 py-2 shadow-md">
                              Currently Active
                            </Badge>
                            <motion.div
                        ...
                        >
                          <div className="rounded-3xl border border-rose-200/60 bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50 p-8 shadow-xl shadow-rose-100/30 transition-all duration-300 hover:shadow-rose-200/40 hover:shadow-2xl">
                            <div className="flex items-center gap-6">
                              ...
                              <div className="flex-1">
                                ...
                                <p className="mt-1 font-semibold text-slate-600 text-lg">
                      ...
                      <div className="space-y-6">
                        <div className="flex items-center gap-3">
                          <div className="h-px bg-gradient-to-r from-indigo-200 to-transparent flex-1"></div>
                          <Badge className="border-0 bg-blue-100 font-semibold text-blue-700 px-4 py-2 shadow-md">
                            Available Advisors
                          </Badge>
                          <div className="h-px bg-gradient-to-r from-transparent to-indigo-200 flex-1"></div>
                        </div>

                        <div className="space-y-4">
                          {otherExecutives.map(([key, personality], index) => (
                            <motion.button
                              animate={{ opacity: 1, x: 0 }}
                              ...
                              initial={{ opacity: 0, x: 20 }}
                              key={key}
                              onClick={() => handleExecutiveSelect(key as BotType)}
                              transition={{
                                duration: 0.4,
                                delay: 0.1 + index * 0.1,
                              }}
                              ...
                              whileTap={{ scale: 0.98 }}
                            >
                              <div className="rounded-2xl border border-white/40 bg-gradient-to-r from-white to-slate-50/30 p-6 shadow-lg transition-all duration-300 hover:border-indigo-200/60 hover:bg-gradient-to-br hover:from-indigo-50/30 hover:to-purple-50/30 hover:shadow-xl hover:shadow-indigo-100/20">
                                <div className="flex items-center gap-4">
                                  {getExecutiveIcon(key as BotType, "md")}
                                  <div className="flex-1">
                                    <h4 className="text-lg font-bold text-slate-800 transition-colors duration-300 group-hover:bg-gradient-to-r group-hover:from-indigo-600 group-hover:to-purple-600 group-hover:bg-clip-text group-hover:text-transparent">
                                      {personality.name}
                                    </h4>
                    ...
                    <div className="mt-8 flex items-center justify-between border-t border-white/20 pt-6">
                      <p className="text-slate-500 text-sm">
                        Select an advisor to customize your AI conversation experience
                      </p>
                      <Button
